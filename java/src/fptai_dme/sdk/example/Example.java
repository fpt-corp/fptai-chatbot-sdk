...
import fptai_dme_sdk.models.DMEPayloadRequest;
import fptai_dme_sdk.models.DMETextRequest;
import fptai_dme_sdk.models.Payload;
...
public class Example {
	public static void main(String [] args) throws IOException {
		...
		System.out.println(dmg.parseResponse("").getChannel());;
